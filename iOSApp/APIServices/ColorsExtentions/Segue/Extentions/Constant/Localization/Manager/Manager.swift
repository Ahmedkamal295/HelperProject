...
let hostName = "https://markati.online/api/"
let hostbosat = "http://newskuwaitna.com/bothat/json_user/"
let HostNameImage = "https://markati.online/"
let hostBanner = HostNameImage + "banners/"
let hostSmall = "small/"
let Hostproducts = HostNameImage  + "products/" + hostSmall
        ...
        net?.listener =
            { status in
                ...
                else
                {
                    ...
                    self.showStatus(image: #imageLiteral(resourceName: "Unknown-2"), message: "No internet")
